export default {
  ...
  'form.confirm-password.placeholder': 'Şifre Tekrar',
  'form.phone-number.placeholder': 'Telefon Numarası',
  'form.verification-code.placeholder': 'Verifasyon Kodu',
  ...
  'menu.home': 'home',
  'menu.dashboard': 'Ürünler',
  'menu.dashboard.urunAra': 'Ürün Ara',
  'menu.dashboard.kaydedilenler': 'Kaydedilenler',
  'menu.dashboard.ziyaretEdilenler': 'Ziyaret Edilenler',
  'menu.dashboard.okutulmusUrunler': 'Okutulmuş Ürünler',
  'menu.Notlar': 'Notlar',
  'menu.Notlar.ekrangoruntu': 'Ekran Görüntüsü',
  'menu.Notlar.Listeler': 'Listeler',
  'menu.google': 'Google',
  'menu.google.google': 'Google Search',
  'menu.sozluk': 'Sözlük',
  'menu.sozluk.Sozluk': 'Sözlükde Ara',
  'menu.translate': 'Çeviri',
  'menu.translate.translate': 'Çevir',
  'menu.kisi': 'Kişiler',
  'menu.kisi.kisi': 'Kişi Ara',
  'menu.trendler': 'Trendler',
  'menu.trendler.trendler': 'Trend',
  'menu.vikipedia': 'Vikipedia',
  'menu.vikipedia.vikipedia': 'Vikipedia',
  'menu.form': 'Form',
